...
const HeaderNavigation = () => {
  ...
  return (
    <header className="relative overflow-hidden border-b border-gray-200 shadow-sm bg-gradient-to-r from-gray-100 to-gray-50">
      ...
      <nav className="relative z-10 px-6 mx-auto max-w-7xl lg:px-20">
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="flex flex-col items-start gap-2 mt-4 md:hidden">
            <Button
              variant="outline"
              className="w-full h-11 rounded-xl text-[#3b5d22] border-[#3b5d22] hover:bg-[#f1f5f0]"
              asChild
            >
